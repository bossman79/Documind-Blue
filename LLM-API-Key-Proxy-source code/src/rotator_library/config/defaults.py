...
# When Ollama Cloud API keys are loaded, proxy_app raises the effective timeout to at
# least OLLAMA_CLOUD_GLOBAL_TIMEOUT_FLOOR (default 100 in main.py) so bursts of 429s can
# clear transient key cooldowns (often ~60s). Set OLLAMA_CLOUD_GLOBAL_TIMEOUT_FLOOR=0 to skip.
