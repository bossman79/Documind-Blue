...
exports.CAD_VISION_INITIAL_LONG_SIDE = void 0;
exports.buildVisionSystemPrompt = buildVisionSystemPrompt;
const BASE = `
...
`.trim();
function buildVisionSystemPrompt(args) {
...
exports.CAD_VISION_INITIAL_LONG_SIDE = 3840;
